...
impl Kzg {
    ...
    pub fn commit_with_cache(
        // TODO: we probably want one for polynomials in evaluation form?
        // Although seems like the functions that are using the cache will get removed.
        // See: https://github.com/Layr-Labs/rust-kzg-bn254/issues/20#issuecomment-2570001974
        polynomial: &PolynomialCoefForm,
        cache_dir: &str,
