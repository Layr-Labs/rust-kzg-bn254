...
mod tests {
    ...
    use rust_kzg_bn254_batch_verification::batch::verify_blob_kzg_proof;
    ...
    lazy_static! {
        ...
        static ref SRS_INSTANCE: SRS = SRS::new(
            "../kzg/tests/test-files/mainnet-data/g1.131072.point",
            268435456,
            131072
        )
        .unwrap();
    ...
    fn test_kzg_batch_proof_with_infinity() {
        ...
        let result = verify_blob_kzg_proof(&blobs, &commitments, &proofs);
        ...
        let result_mixed = verify_blob_kzg_proof(&blobs_mixed, &commitments_mixed, &proofs_mixed);
